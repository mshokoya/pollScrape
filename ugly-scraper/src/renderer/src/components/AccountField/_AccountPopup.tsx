    ...
    >
      ...
      >
        ...
        {obs.page.get() === 'update' ? (
          ...
          <MainFields {...p} handleRequest={handleRequest} obs={obs} />
        )}
      </div>
    </div>
  )
      ...
      >
        <div className="mb-3">
          ...
          <input
            ...
            onChange={(e) => {
              obs.input.set((p) => ({ ...p, email: e.target.value }))
            }}
          />
        </div>
        ...
        <div className="mb-3">
          ...
          <input
            ...
            onChange={(e) => {
              obs.input.set((p) => ({ ...p, password: e.target.value }))
            }}
          />
        </div>
        ...
        <div className="mb-3">
          ...
          <input
            type="text"
            id="recovery"
            value={obs.input.recoveryEmail.get()}
            onChange={(e) => {
              obs.input.set((p) => ({ ...p, recoveryEmail: e.target.value }))
            }}
          />
        </div>
