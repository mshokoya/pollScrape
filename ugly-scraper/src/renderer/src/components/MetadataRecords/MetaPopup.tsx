    ...
    >
      ...
      >
        ...
        <div>
          ...
          <button disabled={reqInProcess} onClick={submitChange}>
            Rename Account
          </button>
        </div>

        <div>
          <button disabled={reqInProcess} onClick={continueScraping}>
            continue scraping
          </button>
        </div>

        <div>
          <button disabled={reqInProcess} onClick={deleteAccount}>
            Delete Account
          </button>
        </div>
      </div>
