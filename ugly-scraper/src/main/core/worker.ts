...
export const accountFindOne = async () =>
  await MetaDataModel_.findOne({ url: 'testaEmal@email.com' })

export const accountFindById = async () => await MetaDataModel_.findById(1)

export const accountFindOneAndUpdate = async () =>
  await MetaDataModel_.addToObj({ url: 'testaEmal@email.com' }, 'params', {scrapeID: 'kldas', listName: 'idds', length: 1, date: 3453})

export const accountFindOneAndDelete = async () =>
  await MetaDataModel_.findOneAndDelete({ url: 'testaEmal@email.com' })
